    ...
    return (
        <>
            ...
            <div className="row">
                ...
                <button onClick={handleClick} className="col-4 h-75 btn btn-primary" name='username' >Edit</button>
            </div><br /><br />
            <div className="row">
                <div className="col">Email</div>
                <button className="col-4 h-75 btn btn-primary" name='email' >Edit</button>
            </div><br /><br />
            <div className="row">
                <div className="col">Password</div>
                <button className="col-4 h-75 btn btn-primary" name='password' >Edit</button>
            </div><br /><br />
